...
2. O script lê a **marca-d'água** em `estado.json` e busca no Linear as issues do time Numih concluídas desde então. Se o cron falhar uma semana, nada se perde: a execução seguinte cobre o período acumulado.
